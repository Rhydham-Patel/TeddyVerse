...
const UserListDialogNew = () => {
	...
	return (
		<Dialog>
			<DialogTrigger>
				<Button className="w-max bg-gray-primary dark:bg-gray-300 hover:dark:bg-white m-[5px] align-center mt-5 hover:bg-purple-300">
				<MessageSquareDiff size={20} className="text-black"/>
				<text className="text-black ml-5">Start Conversation</text>
				</Button>
			</DialogTrigger>
			<DialogContent>
				<DialogHeader>
				...
				<div className='flex flex-col gap-3 overflow-auto max-h-60'>
					{users?.map((user) => (
						<div
							...
							${selectedUsers.includes(user._id) ? "bg-gray-primary" : ""}`}
							onClick={() => {
...
export default UserListDialogNew;
