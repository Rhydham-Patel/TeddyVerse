...
import LeftPanelMobile from "./left-panel-mobile";
...
const RightPanel = () => {
	...
	if (!selectedConversation) return <LeftPanelMobile/>;
	...
	return (
		<div className='w-full flex flex-col bg-chat-tile-light dark:bg-chat-tile-dark bg-cover'>
			<div className='w-full sticky top-0 z-50 h-max'>
				{/* Header */}
