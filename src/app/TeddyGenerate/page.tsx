...
const TeddyGeneratePage = () => {
    return (
      ...
      <Link 
        href="/" 
        className="fixed top-8 left-8 flex items-center gap-2 bg-purple-950 px-3 py-2 rounded-full shadow-lg hover:bg-purple-600 transition z-50"
      >
  ...
  export default TeddyGeneratePage;
